(custom-set-variables
 ...
 '(package-selected-packages
   '(web-mode rust-mode projectile magit flycheck exec-path-from-shell evil doom-themes auto-package-update auto-complete add-node-modules-path use-package)))
